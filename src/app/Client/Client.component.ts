...
export class ClientComponent implements OnInit {
  ...
  AddClient: Client = { id: 0, fullName: '', email: '', phoneNumber: '', address: '', dateAjout: new Date(), entrepriseId: 0 };
  ...
  selectedClient: Client = { id: 0, fullName: '', email: '', phoneNumber: '', address: '', dateAjout: new Date(), entrepriseId: 0 };
  ...
  toggleAddClientInfo() {
    ...
    this.AddClient = { id: 0, fullName: '', email: '', phoneNumber: '', address: '', dateAjout: new Date(), entrepriseId: 0 };
  ...
  validateForm() {
    ...
    if (!this.showNameError && !this.showEmailError) {
      this.submitForm();
    }
  }
      ...
      accept: () => {
        this.clientService.deleteClient(this.selectedClient!.id).subscribe({
          next: () => {
            ...
            this.selectedClient = { id: 0, fullName: '', email: '', phoneNumber: '', address: '', dateAjout: new Date(), entrepriseId: 0 };
            this.loadClients();
          },
          error: err => {
  ...
  ModifyClient(): void {
    ...
    const updatedClient: Client = {
      ...
      dateAjout: this.selectedClient.dateAjout, // Fix: add required property
